  ...
  return (
    <section className="space-y-6">
      <div>
        ...
        <p className="mt-4 text-sm font-medium uppercase tracking-wide text-slate-500">Admin only</p>
        <h1 className="mt-1 text-2xl font-semibold text-slate-950 sm:text-3xl">Staff access</h1>
