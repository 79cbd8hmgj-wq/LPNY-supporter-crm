  ...
  return (
    <div className="mx-auto max-w-2xl space-y-5">
      <header>
        ...
        <h1 className="mt-1 text-2xl font-semibold tracking-tight text-lp-950">Quick Add</h1>
        <p className="mt-1 text-sm leading-6 text-lp-600">
      ...
      {staff.role === "volunteer_staff" ? (
        <section className="rounded-xl border border-lp-200 bg-white p-5 shadow-sm">
          <h2 className="font-semibold text-lp-950">Quick Add is not available for this role.</h2>
          <p className="mt-1 text-sm leading-6 text-lp-600">
