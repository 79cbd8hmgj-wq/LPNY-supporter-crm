...
export function PeopleFilters({
  ...
  return (
    <form action="/crm/people" method="get" className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
      <div className="grid gap-3 lg:grid-cols-[minmax(0,2fr)_1fr_1fr_auto]">
        ...
        <div className="flex items-end gap-2">
          ...
          <Link className="min-h-11 rounded-lg border border-slate-300 px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50" href="/crm/people">
            Clear
          </Link>
        </div>
      </div>
