...
export function MfaEnrollment() {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-slate-600">Scan the QR code in your authenticator app.</p>
      <p className="break-all rounded-md bg-slate-100 p-3 text-sm">Manual key: {state.secret}</p>
